...
def make_rscale_plot(df, save=False, panel=True):
    ...
    if panel:
        ...
        axa6.axvline(
            ...
            ls="--",
            c="k",
            label=rf"$R_\mathrm{{pole}}/r_p$ = {r_scales[r6_min_ind]:.3f}",
        )
        ...
        axa10.axvline(
            ...
            ls="--",
            c="k",
            label=rf"$R_\mathrm{{pole}}/r_p$ = {r_scales[r10_min_ind]:.3f}",
        )
        ...
        axa14.axvline(
            ...
            ls="--",
            c="k",
            label=rf"$R_\mathrm{{pole}}/r_p$ = {r_scales[r14_min_ind]:.3f}",
        )
...
def plot_volt_max(df, voltages, interp=False, val=0.5):
    ...
    if interp:
        ...
        ax.axvline(x=xnew[ind], ls="--", c="k", label=rf"$V_q$ = {xnew[ind]:.3f} kV")
