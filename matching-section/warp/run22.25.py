...
#   emitting radius
warpoptions.parser.add_argument(
    "--emit", dest="emittingRadius", type=float, default="0.4e-3"
)  # .37e-3 #.25
...
if loadbeam == "":
    ...
    wp.top.npmax = 16000  # maximal number of particles (for injection per timestep???)
    wp.top.inject = 1  # 2 means space-charge limited injection
    wp.top.npinject = 400 # approximate number of particles injected per step
...
V_esq = [100,-300,350,-300,225,-250,200,-200,0]#,500,500,500,500]
d_drift = 1e-3
d_esq =1.59e-3 
d_beginning=0
...
conductors=esq0+esq1+esq2+esq3+esq4+esq5+esq6+esq7+esq8#+esq9+esq10+esq11+esq12+esq13+esq14+esq15+esq16+esq17+esq18+esq19
