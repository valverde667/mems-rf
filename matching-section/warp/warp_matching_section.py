...
from geometry_singlet import RF_stack, ESQ_doublet, ESQ_singlet
import geometry
...
V_esq =[  90.91, -227.27,  227.27, -140.91,   90.91,  -72.73,   63.64,
        -54.55,   54.55,  -54.55,   50.  ,  -54.55,   59.09,  -54.55,
         50.  ,  -50.  ,   54.55,  -59.09,   59.09]
d_drift = 1e-3
d_esq =1.59e-3 
d_beginning=0
