...
#   divergence angle
warpoptions.parser.add_argument(
    "--diva", dest="divergenceAngle", type=float, default="0e-3"
)
...
now = datetime.now()
# dd/mm/YY H:M:S
dt_string = now.strftime("Run11.0_%Y_%m_%d__%H_%M_%S")
...
warpoptions.parser.add_argument(
    "--ibeaminit", dest="ibeaminit", type=float, default=1e-100
)
...
voltages = [119.7, 320.16, 371.37, 341.76, 332.08, 274.18, 300, 300, 300, 300]
