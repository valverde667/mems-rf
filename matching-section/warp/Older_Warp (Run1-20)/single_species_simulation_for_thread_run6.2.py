...
voltages = [300, 300, 300, 300]
volt_ratio = [1.04, 1.05, 1, 1]
invertPolarity=[1,-1,1,-1]
#if not warpoptions.options.autorun:
 #   for i in range(len(esq_positions)):
 #   	print(f"ESQ POS at \n esq_positions[i]")
 #   	conductors += ESQ(esq_positions[i], invertPolarity[i], voltages[i])
...
conductors=esq0+esq1+esq2+esq3
