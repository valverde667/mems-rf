...
#   emitting radius
warpoptions.parser.add_argument(
    "--emit", dest="emittingRadius", type=float, default="0.5e-3"
)  # .37e-3 #.25

#   divergence angle
warpoptions.parser.add_argument(
    "--diva", dest="divergenceAngle", type=float, default="15e-3"
)

#   special cgm name - for mass output / scripting
warpoptions.parser.add_argument("--name", dest="name", type=str, default="Run4.0")
...
positionArray = [
    [0.0136525, 0.01634749, 0.019243267, 0.02312737],
...
t_wafer = 2.59 * wp.mm #625 * wp.um + 35 * 2 * wp.um
esq_positions = [
     0.00259,
     0.00518,
     0.00777,#gap in between third and 4th
     0.01036,#0.0912985,
     #0.11285,
     #0.136544,
     #0.16212,
...
voltages = [400, -400, -400, 350]
#, -500, 500, 500, -500, 550, 500, 500, 500, 500, 500, 500, 500, 500, 500]
volt_ratio = [1.04, 1.05, 1.04, 1.04]
#, 1, 1.02, 1.02, 1.05, 1.04, 1.04, 1.04, 1.04, 1.04, 1.04, 1.04, 1.04, 1.04, 1.04]
...
length = positionArray[-1][-1] + 5 * wp.mm #brian changed to 5 from 25
