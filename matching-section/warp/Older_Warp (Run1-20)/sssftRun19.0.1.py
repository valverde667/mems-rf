...
#   divergence angle
warpoptions.parser.add_argument(
    "--diva", dest="divergenceAngle", type=float, default="4e-3"
)
...
now = datetime.now()
# dd/mm/YY H:M:S
dt_string = now.strftime("Run19.0.0_%Y_%m_%d__%H_%M_%S")
...
from geometry_test8 import RF_stack, ESQ_doublet, ESQ_singlet
import geometry
