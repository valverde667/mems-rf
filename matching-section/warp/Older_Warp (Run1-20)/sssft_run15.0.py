...
#   emitting radius
warpoptions.parser.add_argument(
    "--emit", dest="emittingRadius", type=float, default=".19e-3"
)  # .37e-3 #.25

#   divergence angle
warpoptions.parser.add_argument(
    "--diva", dest="divergenceAngle", type=float, default="0"
)
...
now = datetime.now()
# dd/mm/YY H:M:S
dt_string = now.strftime("Run15.0_%Y_%m_%d__%H_%M_%S")
...
from geometry_8mmESQ import RF_stack, ESQ_doublet, ESQ
import geometry
...
V_esq = [2.070197E1, -5.201558E1, 7.244016E1, -8.024E1]
d_drift = 1e-3
d_esq =8e-3 
d_beginning=0
