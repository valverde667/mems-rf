...
now = datetime.now()
# dd/mm/YY H:M:S
dt_string = now.strftime("Run16.0_%Y_%m_%d__%H_%M_%S")
...
from geometry_test5 import RF_stack, ESQ_doublet, ESQ_singlet
import geometry
...
tmax = length / velo*2  # this is used for the maximum time for timesteps
