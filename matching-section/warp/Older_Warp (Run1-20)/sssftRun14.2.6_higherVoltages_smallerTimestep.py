...
now = datetime.now()
# dd/mm/YY H:M:S
dt_string = now.strftime("Run14.2.6_higherVoltages_%Y_%m_%d__%H_%M_%S")
...
#   divergence angle
warpoptions.parser.add_argument(
    "--tstep", dest="timestep", type=float, default="5e-10"
)  # 1e-11
...
from geometry_test import RF_stack, ESQ_doublet, ESQ_singlet
import geometry
...
V_esq = [1000,-3000,2500,-1500,1500]
d_drift = 4e-3
d_esq =1.59e-3 
d_beginning=0
