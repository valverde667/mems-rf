...
#   emitting radius
warpoptions.parser.add_argument(
    "--emit", dest="emittingRadius", type=float, default=".4e-3"
)  # .37e-3 #.25

#   divergence angle
warpoptions.parser.add_argument(
    "--diva", dest="divergenceAngle", type=float, default="12e-3"
)
...
now = datetime.now()
# dd/mm/YY H:M:S
dt_string = now.strftime("Run9.0_%Y_%m_%d__%H_%M_%S")
...
esq_positions = [0.00259, 0.00518, 0.00777, 0.01036, 0.01295, 0.01554, 0.01813, 0.02072, 0.02331, 0.0259,0.0285,0.03108,0.03367]
...
esq10 = ESQ(esq_positions[10], invertPolarity[10], voltages[10])
esq11 = ESQ(esq_positions[11], invertPolarity[11], voltages[11])
esq12 = ESQ(esq_positions[12], invertPolarity[12], voltages[12])

conductors=esq0+esq1+esq2+esq3+esq4+esq5+esq6+esq7+esq8+esq9+esq10+esq11+esq12
