...
ax.set_xlabel(r"Rod Radius to Aperture Ratio $R_{rod}/r_p$")
ax.set_ylabel(r"Fraction of Rod Used")
ax.set_zlabel(r"Normalizeded Multipole Moment $A_6/|A_2|$", fontsize="small")
ax.scatter3D(rod_rad, rod_fracs / 2, a6)
...
ax.set_xlabel("Fraction of Rod Used ")
ax.set_ylabel(r"Normalized Coefficient $\frac{A_6}{|A_2|}$")
ax.scatter(rod_fracs / 2, abs(a6))
ax.axhline(y=0, c="k", lw=0.2)
plt.tight_layout()
