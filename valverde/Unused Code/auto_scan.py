...
parameter_list = np.arange(
    float(start), float(end), float(iterations)
)  # stops before last entered number in end

# print(parameter_list) #check if list has proper numbers

for i, x in enumerate(parameter_list):
    print(
        f"........This is the start of parameter change {i+1} for {parameter_name}........"
    )
