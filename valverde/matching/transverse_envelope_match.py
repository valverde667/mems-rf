...
beam.ap0 = 0.0
beam.bp0 = 0.0
beam.ibeam = 2.0 * wp.mA
beam.vbeam = 0.0
beam.ekin = 80.0 * wp.kV
...
hlp = 36.0 * wp.cm  # half lattice period length
...
wp.addnewquad(zs=0.5 * hlp - quadlen / 2.0, ze=0.5 * hlp + quadlen / 2.0, db=+dbdx)
wp.addnewquad(zs=1.5 * hlp - quadlen / 2.0, ze=1.5 * hlp + quadlen / 2.0, db=-dbdx)
...
wp.env.dzenv = wp.top.tunelen / 100.0
